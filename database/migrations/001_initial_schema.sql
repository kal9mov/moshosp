-- +migrate Up
-- Основная начальная миграция для создания схемы базы данных проекта
...
DROP TRIGGER IF EXISTS help_requests_update_trigger ON help_requests;
DROP FUNCTION IF EXISTS help_requests_trigger();
DROP INDEX IF EXISTS help_requests_fts_idx;
DROP INDEX IF EXISTS idx_notifications_read;
DROP INDEX IF EXISTS idx_notifications_user;
DROP INDEX IF EXISTS idx_user_achievements_user;
DROP INDEX IF EXISTS idx_help_requests_volunteer;
DROP INDEX IF EXISTS idx_help_requests_requester;
DROP INDEX IF EXISTS idx_help_requests_status;

DROP TRIGGER IF EXISTS update_partner_organizations_modtime ON partner_organizations;
DROP TRIGGER IF EXISTS update_user_game_data_modtime ON user_game_data;
DROP TRIGGER IF EXISTS update_user_achievements_modtime ON user_achievements;
DROP TRIGGER IF EXISTS update_achievements_modtime ON achievements;
DROP TRIGGER IF EXISTS update_request_comments_modtime ON request_comments;
DROP TRIGGER IF EXISTS update_help_requests_modtime ON help_requests;
DROP TRIGGER IF EXISTS update_request_categories_modtime ON request_categories;
